	...
	<view class="root">
		...
		<view class="item2 flex">
			<view class="left">
				...
				<text class="font-15 color-light p-lr10">合约-网格交易</text>
			</view>
			<view class="flex ">
		...
		<view class="item2 flex">
			<view class="left ">
				<text class="font-13 color-dark">每单购买量:</text>
				<text class="font-15 color-light p-lr10">{{TaskData.BuyCount}}</text>
			</view>
			<view class="left ">
		...
		<view class="item5 flex">
				...
				<text class="font-13 color-dark">累计开单:</text>
				<text class="font-15 color-green ">{{TaskData.BuyOrderCount}}</text>
			<text class="font-13 color-dark">已完成:</text>
			<text class="font-15 color-green ">{{TaskData.ProfitOrderCount}}</text>
