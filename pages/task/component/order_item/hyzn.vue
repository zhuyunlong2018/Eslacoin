	...
	<view class="root">
		<view class="content-item flex">
			<view class="left flex flex-start">
				...
				<text class="font-13 p-l10"  :class="item.BuyDirection=='buy'?'color-green':'color-danger'">{{item.BuyDirection=='buy'?'开多':'开空'}}</text>
			</view>
			<view class="center flex flex-start">
				<text class="font-13 color-dark">数量:</text>
				<text class="font-15 color-light p-l10">{{item.BuyCount.toFixed(4)}}</text>
			</view>
		...
		<view class="content-item flex ">
			<view class="left flex flex-start">
				<text class="font-12 color-light">{{item.CreateTime.slice(5,16)}}</text>
			</view>
			<view class="center flex flex-start">
				<text class="font-13 color-dark">均价:</text>
		...
		<uni-popup ref="popup" type="hyzn">
			<uni-popup-hyzn :OrderInfo="item" :TaskType="TaskType"></uni-popup-hyzn>
		</uni-popup>
