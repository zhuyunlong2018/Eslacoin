	...
	<view class="uni-popup-detail">
		...
		<view class="uni-detail-content">
			<view class="uni-detail-content-item" style="height: 60rpx;">
					<text class="font-13 color-dark ">开仓价格区间:</text>
			...
			<view class="uni-detail-content-item">
				<text class="font-13 buy-time color-dark">开仓方向</text>
				<text class="font-13 buy-price text-center color-dark">开仓单价</text>
				<text class="font-13 buy-price text-center color-dark">开仓数量</text>
				<text class="font-13 buy-price text-right color-dark">开仓总价</text>
			</view>
			<view class="uni-detail-content-item item-long">
				<text class="font-12 buy-time " :class="info.BuyDirection=='buy'?'color-green':'color-danger'">{{BuyDirectionName}}</text>
				<text
		...
		<view class="uni-detail-content">
			...
			<view class="uni-detail-content-item-title-big">
				<text class="font-13 color-light color-light">平仓订单</text>
				<text class="font-15 color-light">{{info.SellClientOrderId}}</text>
			</view>
			<view class="uni-detail-content-item">
				<text class="font-13 buy-time color-dark">平仓方向</text>
			...
			<view class="uni-detail-content-item item-long">
				<text class="font-12 buy-time color-light">{{SellDirectionName}}</text>
				<text
...
<script>
	export default {
		...
		computed: {
			...
			BuyDirectionName() {
				let state = this.info.BuyDirection;
				let str = '';
				switch (state) {
					case 'buy':
						str = '开多';
			...
			SellDirectionName() {
				let state = this.info.SellDirection;
				let str = '';
				switch (state) {
					case 'buy':
						str = '平空';
